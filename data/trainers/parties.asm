...
FalknerGroup:
	...
	db 12, PIDGEY,     TACKLE, MUD_SLAP, SAND_ATTACK, NO_MOVE
	db 12, SKARMORY,   TACKLE, SWORDS_DANCE, NO_MOVE, NO_MOVE
	db 13, FARFETCH_D, RAZOR_LEAF, FURY_ATTACK, GUST, NO_MOVE
	db 14, BUTTERFREE, TACKLE, HARDEN, CONFUSION, WHIRLWIND
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 19, CLEFAIRY,   DOUBLESLAP, SURF, ENCORE, METRONOME
	db 23, MILTANK,    ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db 24, GIRAFARIG,  CONFUSION, ATTRACT, STOMP, MUD_SLAP
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_MOVES
	db 19, PINECO,     SELFDESTRUCT, TACKLE, NO_MOVE, NO_MOVE
	db 18, BUTTERFREE, POISONPOWDER, NO_MOVE, NO_MOVE, NO_MOVE
	db 18, BEEDRILL,   TOXIC, NO_MOVE, NO_MOVE, NO_MOVE
...
JasmineGroup:
	...
	; $21 and $01 should be in consecutive order for the delimiter to work
	; You can't use $21 and $01 in adjacent constants.
	
	; $21 corresponds to NIDORINO, X_ACCURACY, AND TACKLE
	; $20 corresponds to NIDORAN_M, RARE_CANDY, HORN_DRILL
	
	; Example of illegal Pokémon team:
	; 
	; db (21, NIDORAN_M),	(X_ACCURACY,  	HORN_DRILL), (TACKLE, HORN_DRILL), (TACKLE
	; db 20), (NIDORINO,	RARE_CANDY), 	WING_ATTACK, SPIKES, WHIRLWIND, HEADBUTT
	
	; No badges 
	db TRAINERTYPE_ITEM_MOVES
	db 30, MAGNEMITE,	MAGNET,  		THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 30, SKARMORY, 	SHARP_BEAK,		WING_ATTACK, SPIKES, WHIRLWIND, HEADBUTT
	db 35, STEELIX,    	METAL_COAT,		SCREECH, SUNNY_DAY, ROCK_THROW, IRON_TAIL
	db $21, $20 ; delimiter
	...
	; 5 badges 
	db TRAINERTYPE_ITEM_MOVES
	db 32, MAGNEMITE,	MAGNET,  		THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 32, SKARMORY, 	SHARP_BEAK,		WING_ATTACK, SPIKES, WHIRLWIND, HEADBUTT
	db 33, FORRETRESS,	NO_ITEM,		SWIFT, RAPID_SPIN, EXPLOSION, SPIKES
	db 36, STEELIX,    	METAL_COAT,		SCREECH, SUNNY_DAY, ROCK_THROW, IRON_TAIL
	db $ff ; end
...
Rival1Group:
	...
	db 14, GASTLY,		LICK, SPITE, CURSE, SELFDESTRUCT
	db 15, ZUBAT,		LEECH_LIFE, WING_ATTACK, BITE, SUPERSONIC
	db 16, CROCONAW,	LEER, AQUA_JET, WATER_GUN, BITE
	db -1 ; end

	; RIVAL1 (7)
	db "?@", TRAINERTYPE_MOVES
	db 20, HAUNTER,    LICK, SPITE, MEAN_LOOK, CURSE
	db 18, MAGNEMITE,  THUNDER_WAVE, THUNDERSHOCK, HARDEN, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, WING_ATTACK, BITE, CONFUSE_RAY
	...
	db 18, MAGNEMITE,  THUNDER_WAVE, THUNDERSHOCK, HARDEN, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, WING_ATTACK, BITE, CONFUSE_RAY
	db 22, CROCONAW,   LEER, AQUA_JET, WATER_GUN, BITE
	db -1 ; end
...
KogaGroup:
	...
	db 42, MUK,        MINIMIZE, CURSE, SLUDGE_BOMB, TOXIC
...
SchoolboyGroup:
	...
	db 12, MANKEY,   LEER, NO_MOVE, NO_MOVE, NO_MOVE
	db 15, VOLTORB,  SONICBOOM, TACKLE, NO_MOVE, NO_MOVE
	db -1 ; end
	...
	db 35, GROWLITHE,  SUNNY_DAY, LEER, HEADBUTT, FLAME_WHEEL
...
BirdKeeperGroup:
	...
	db 12, PIDGEY, FLY, NO_MOVE, NO_MOVE, WING_ATTACK
	db 14, PIDGEOTTO, WING_ATTACK, TACKLE, SAND_ATTACK, MUD_SLAP
	db -1 ; end
...
LassGroup:
	...
	db 21, PIDGEOTTO,  TACKLE, SAND_ATTACK, GUST, QUICK_ATTACK
	db -1 ; end
...
BeautyGroup:
	...
	db 17, HOPPIP,     SYNTHESIS, TACKLE, POISONPOWDER, NO_MOVE
	db 17, SKIPLOOM,   SYNTHESIS, TAIL_WHIP, MEGA_DRAIN, STUN_SPORE
	db 18, GEODUDE,    SANDSTORM, TACKLE, ROCK_THROW, MAGNITUDE
	db 17, MAGNEMITE,  THUNDER_WAVE, CONFUSE_RAY, SONICBOOM, THUNDERSHOCK
	db -1 ; end
...
GruntMGroup:
	...
	db 15, ZUBAT,		LEECH_LIFE, SUPERSONIC, BITE, NO_MOVE
	db 15, QWILFISH,	SPIKES, POISON_STING, TACKLE, HARDEN
	db 15, GEODUDE,		MAGNITUDE, ROCK_THROW, TACKLE, NO_MOVE
	db 16, MACHOP,		LOW_KICK, KARATE_CHOP, LEER, SCARY_FACE	 
	db -1 ; end
...
BugCatcherGroup:
	...
	db 12, PARAS,	DIG, ABSORB, SCRATCH, GROWTH
	db 12, LEDYBA,	TACKLE, SUPERSONIC, SWIFT, NO_MOVE
	db -1 ; end
...
FisherGroup:
	...
	db 34, SEAKING,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_ATTACK
	db 37, QWILFISH,   ROLLOUT, SURF, PIN_MISSILE, HEADBUTT
	db -1 ; end
...
SwimmerFGroup:
	...
	db 21, HORSEA,     AQUA_JET, SMOKESCREEN, LEER, WATER_GUN
...
SailorGroup:
	...
	db 18, KRABBY,     AQUA_JET, LEER, VICEGRIP, HARDEN
...
HikerGroup:
	...
	db 12, GEODUDE,   MAGNITUDE, SELFDESTRUCT, DEFENSE_CURL, ROLLOUT
	db 12, MACHOP,    HI_JUMP_KICK, VITAL_THROW, HEADBUTT, DIG
	db -1 ; end
	...
	db 35, PILOSWINE,  EARTHQUAKE, BLIZZARD, REST, HEADBUTT
...
BurglarGroup:
	...
	db 26, GROWLITHE,  ROAR, EMBER, LEER, HEADBUTT
...
ExecutiveMGroup:
	...
	; EXECUTIVEM (4)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 31, RATICATE, 	HYPER_FANG, CRUNCH, QUICK_ATTACK, PURSUIT
	db 32, PRIMEAPE,	PURSUIT, CROSS_CHOP, SEISMIC_TOSS, FOCUS_ENERGY
	db 31, WEEZING,		SELFDESTRUCT, SLUDGE_BOMB, TOXIC, HAZE
	db 32, SANDSLASH,	FURY_CUTTER, MAGNITUDE, SWIFT, SLASH
	db 33, DITTO,		TRANSFORM, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end
...
PicnickerGroup:
	...
	db 15, VULPIX, SUNNY_DAY, QUICK_ATTACK, EMBER, TAIL_WHIP
	db -1 ; end
...
ExecutiveFGroup:
	...
	; EXECUTIVEF (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 32, ARBOK,      SLUDGE_BOMB, SCREECH, CRUNCH, GLARE
	db 32, OCTILLERY,  AURORA_BEAM, BUBBLEBEAM, PSYBEAM, OCTAZOOKA
	db 31, VILEPLUME,  GIGA_DRAIN, SLUDGE_BOMB, TOXIC, MOONLIGHT
	db 34, MURKROW,    WING_ATTACK, PURSUIT, HAZE, NIGHT_SHADE
	db 33, HYPNO,	   SHADOW_BALL, PSYCHIC_M, HYPNOSIS, SUBSTITUTE
	db -1 ; end
...
KimonoGirlGroup:
	...
	db 17, ESPEON, LIGHT_SCREEN, REFLECT, PSYBEAM, QUICK_ATTACK
	db -1 ; end

	; KIMONO_GIRL (4)
	db "ZUKI@", TRAINERTYPE_MOVES
	db 17, VAPOREON, QUICK_ATTACK, TACKLE, HARDEN, BATON_PASS
	db 17, UMBREON,  LIGHT_SCREEN, REFLECT, FAINT_ATTACK, QUICK_ATTACK
	db -1 ; end
...
PokefanFGroup:
	...
	db 15, VULPIX,   BERRY,   SUNNY_DAY, QUICK_ATTACK, EMBER, LEER
	db 15, GEODUDE,   BERRY,   ROLLOUT, DEFENSE_CURL, MUD_SLAP, HEADBUTT
	db -1 ; end
...
OfficerGroup:
	...
	db 14, CHINCHOU, WILD_CHARGE, SURF, WATERFALL, WHIRLPOOL
	db 17, MAGNEMITE, SONICBOOM, NO_MOVE, NO_MOVE, NO_MOVE
	db 14, GROWLITHE, CROSS_CHOP, EMBER, QUICK_ATTACK, TACKLE
	db -1 ; end
...
GruntFGroup:
	...
	db 31, ARBOK,      ACID, BITE, WRAP, GLARE
	db 31, SANDSLASH,  SLASH, ROCK_TOMB, ROCK_SMASH, MAGNITUDE
	db 30, OCTILLERY,  BUBBLEBEAM, PSYBEAM, SMOKESCREEN, ICE_BEAM
	db -1 ; end
...
MysticalmanGroup:
	...
	db GOLD_BERRY
	db SYNTHESIS, GIGA_DRAIN, SLUDGE_BOMB, STUN_SPORE
