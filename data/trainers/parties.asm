...
Rival1Group:
	...
	db 18, MAGNEMITE,  THUNDER_WAVE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
...
SabrinaGroup:
	...
	db 46, ESPEON,     SAND_ATTACK, QUICK_ATTACK, SWIFT, PSYBEAM
...
KimonoGirlGroup:
	...
	db 17, ESPEON, LIGHT_SCREEN, REFLECT, PSYCHIC_M, QUICK_ATTACK
	db -1 ; end
