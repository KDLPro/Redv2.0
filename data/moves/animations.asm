...
BattleAnim_ThrowPokeBall:
	...
	anim_obj ANIM_OBJ_POKE_BALL, 64, 107, $40
	anim_obj ANIM_OBJ_POKE_BALL_BG, 64, 107, $40
	anim_wait 36
	anim_obj ANIM_OBJ_POKE_BALL, 136, 46, $20
	anim_setobj $3, $7
	anim_obj ANIM_OBJ_POKE_BALL_BG, 136, 46, $20
	anim_setobj $4, $7
	anim_wait 16
	anim_sound 0, 1, SFX_BALL_POOF
	anim_obj ANIM_OBJ_BALL_POOF, 136, 46, $10
	anim_wait 16
	anim_jump .Shake
...
.TheTrainerBlockedTheBall:
	...
	anim_sound 6, 2, SFX_THROW_BALL
	anim_obj ANIM_OBJ_POKE_BALL_BLOCKED, 64, 99, $30
	anim_wait 20
...
.MasterBall:
	...
	anim_obj ANIM_OBJ_MASTER_BALL_SPARKLE, 136, 50, $31
	anim_obj ANIM_OBJ_MASTER_BALL_SPARKLE, 136, 50, $33
	anim_obj ANIM_OBJ_MASTER_BALL_SPARKLE, 136, 50, $35
	anim_obj ANIM_OBJ_MASTER_BALL_SPARKLE, 136, 50, $37
	anim_wait 64
.Shake:
...
BattleAnim_HiJumpKick:
	...
	anim_wait 32
	anim_sound 0, 1, SFX_JUMP_KICK
	anim_obj ANIM_OBJ_KICK, 112, 36, $0
	anim_setobj $1, $2
	anim_wait 12
	anim_sound 0, 1, SFX_DOUBLE_KICK
...
BattleAnim_AquaJet:
	...
	anim_wait 3
	anim_sound 0, 1, SFX_LICK
	anim_obj ANIM_OBJ_WATERFALL_YFIX, 136, 46, $0
	anim_wait 3
	anim_sound 0, 1, SFX_LICK
	anim_obj ANIM_OBJ_WATERFALL_YFIX, 136, 36, $0
	anim_wait 3
	anim_bgeffect ANIM_BG_SHOW_MON, $0, BG_EFFECT_USER, $0
	anim_wait 16
	anim_ret
...
.loop
	...
	anim_obj ANIM_OBJ_WATER_GUN, 64, 86, $0
	anim_wait 8
...
.loop
	anim_sound 0, 1, SFX_RAZOR_WIND
	anim_obj ANIM_OBJ_SONICBOOM_JP_UNUSED, 64, 92, $4
	anim_wait 6
	anim_loop 8, .loop
	anim_wait 16
	anim_ret
...
BattleAnim_Selfdestruct:
	...
	anim_if_param_equal $1, .param_one
	anim_call BattleAnimSub_Explosion2
	anim_wait 16
	anim_ret

.param_one
	anim_call BattleAnimSub_Boom
	anim_ret
...
.loop
	anim_obj ANIM_OBJ_SING_1, 64, 92, $0
	anim_wait 4
	anim_obj ANIM_OBJ_SING_2, 64, 92, $1
	anim_wait 4
	anim_obj ANIM_OBJ_SING_3, 64, 92, $2
	anim_wait 4
	anim_loop 8, .loop
	anim_wait 64
	anim_ret
...
.loop
	...
	anim_obj ANIM_OBJ_POWDER, 108, 16, $0
	anim_wait 4
	anim_sound 0, 1, SFX_POWDER
	anim_obj ANIM_OBJ_POWDER, 132, 16, $0
	anim_wait 4
	anim_sound 0, 1, SFX_POWDER
	anim_obj ANIM_OBJ_POWDER, 116, 16, $0
	anim_wait 4
	anim_sound 0, 1, SFX_POWDER
	anim_obj ANIM_OBJ_POWDER, 124, 16, $0
	anim_wait 12
	anim_loop 3, .loop
	anim_wait 96
	anim_ret
...
.loop
	anim_sound 0, 1, SFX_POWDER
	anim_obj ANIM_OBJ_POWDER_S, 104, 16, $0
	anim_wait 4
	anim_sound 0, 1, SFX_POWDER
	anim_obj ANIM_OBJ_POWDER_S, 136, 16, $0
	anim_wait 4
	anim_sound 0, 1, SFX_POWDER
	anim_obj ANIM_OBJ_POWDER_S, 112, 16, $0
	anim_wait 4
	anim_sound 0, 1, SFX_POWDER
	anim_obj ANIM_OBJ_POWDER_S, 128, 16, $0
	anim_wait 4
	anim_sound 0, 1, SFX_POWDER
	anim_obj ANIM_OBJ_POWDER_S, 120, 16, $0
	anim_wait 4
	anim_loop 2, .loop
	anim_wait 96
	anim_ret
...
BattleAnim_Slash:
	anim_1gfx ANIM_GFX_CUT
	anim_sound 0, 1, SFX_CUT
	anim_obj ANIM_OBJ_FURY_CUTTER_LEFT, 152, 40, $0
	anim_obj ANIM_OBJ_FURY_CUTTER_LEFT, 148, 36, $0
	anim_wait 28
	anim_ret
...
BattleAnim_Reflect:
	...
	anim_obj ANIM_OBJ_SCREEN_WALL, 84, 100, $0 ;replace this graphic
	anim_wait 24
	anim_sound 0, 0, SFX_SHINE
	anim_obj ANIM_OBJ_SCREEN, 72, 80, $0
	anim_wait 64
...
BattleAnim_WildCharge:
	...
	anim_obj ANIM_OBJ_THUNDERBOLT_BALL, 44, 96, $0
	anim_sound 0, 0, SFX_ZAP_CANNON
	anim_obj ANIM_OBJ_SPARKS_CIRCLE_BIG, 44, 96, $0
	anim_wait 32
	anim_bgeffect ANIM_BG_FLASH_INVERTED, $0, $4, $3
	anim_incobj 1
	anim_incobj 2
...
.loop
	anim_sound 6, 2, SFX_SUPERSONIC
	anim_obj ANIM_OBJ_PSYCHIC, 64, 88, $2
	anim_obj ANIM_OBJ_PSYCHIC, 56, 80, $2
	anim_wait 8
	anim_loop 3, .loop
	anim_wait 56
	anim_ret
...
BattleAnim_PoisonSting:
	...
	anim_obj ANIM_OBJ_POISON_STING, 136, 56, $0
	anim_wait 16
	anim_sound 0, 1, SFX_TOXIC
	anim_obj ANIM_OBJ_SLUDGE_2, 132, 56, $0
	anim_wait 12
	anim_sound 0, 1, SFX_TOXIC
	anim_obj ANIM_OBJ_SLUDGE_2, 116, 60, $0
	anim_wait 12
	anim_sound 0, 1, SFX_TOXIC
	anim_obj ANIM_OBJ_SLUDGE_2, 148, 52, $0
	anim_wait 12
	anim_sound 0, 1, SFX_TOXIC
	anim_obj ANIM_OBJ_SLUDGE_2, 128, 36, $0
	anim_wait 12
	anim_sound 0, 1, SFX_TOXIC
	anim_obj ANIM_OBJ_SLUDGE_2, 140, 50, $0
	anim_wait 12
	anim_sound 0, 1, SFX_TOXIC
	anim_obj ANIM_OBJ_SLUDGE_2, 118, 42, $0
	anim_wait 24
	anim_ret
...
.loop
	...
	anim_obj ANIM_OBJ_PSYCHIC, 64, 88, $4
	anim_wait 4
	anim_loop 10, .loop
	anim_wait 48
	anim_ret
...
.loop
	...
	anim_obj ANIM_OBJ_PSYCHIC, 64, 80, $2
	anim_wait 8
	anim_sound 6, 2, SFX_PSYCHIC
	anim_obj ANIM_OBJ_PSYCHIC, 64, 88, $3
	anim_wait 8
	anim_sound 6, 2, SFX_PSYCHIC
	anim_obj ANIM_OBJ_PSYCHIC, 64, 96, $4
	anim_wait 8
	anim_loop 3, .loop
	anim_wait 32
...
BattleAnim_Rage:
	...
	anim_incobj 1
	anim_sound 0, 0, SFX_KINESIS_2
	anim_obj ANIM_OBJ_ANGER, 32, 80, $0
	anim_wait 20
	anim_call BattleAnim_TargetObj_1Row
	anim_bgeffect ANIM_BG_CYCLE_MON_LIGHT_DARK_REPEATING, $0, BG_EFFECT_USER, $20
...
.obj1
	anim_obj ANIM_OBJ_FURY_CUTTER_RIGHT, 112, 40, $0
.okay
	anim_wait 16
	anim_jumpuntil .loop
	anim_ret
...
BattleAnim_CrossChop:
	anim_1gfx ANIM_GFX_CUT
	anim_sound 0, 1, SFX_CUT
	anim_obj ANIM_OBJ_CROSS_CHOP1, 147, 40, $0
	anim_obj ANIM_OBJ_CROSS_CHOP2, 117, 40, $0
