...
; entries correspond to constants/move_constants.asm
	...
	move DOUBLESLAP,   EFFECT_DOUBLE_HIT,         30, NORMAL,       PHYSICAL,		100, 25,   0
	...
	move X_SCISSOR,    EFFECT_NORMAL_HIT,         85, BUG,          PHYSICAL,		100, 15,   0
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, NORMAL,       PHYSICAL,		100, 30,   0
	move CUT,          EFFECT_NORMAL_HIT,         65, NORMAL,       PHYSICAL,		100, 30,   0
	...
	move SING,         EFFECT_SLEEP,               0, NORMAL,       STATUS,			 80, 15,   0
	...
	move ACID,         EFFECT_DEFENSE_DOWN_HIT,   45, POISON,       SPECIAL,		100, 30,  10
	...
	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        170, NORMAL,       SPECIAL,		 85,  5,   0
	...
	move POISONPOWDER, EFFECT_POISON,              0, POISON,       STATUS,			 95, 35,   0
	...
	move DRAGON_RAGE,  EFFECT_STATIC_DAMAGE,      45, DRAGON,       SPECIAL,		100, 10,   0
	...
	move ROCK_THROW,   EFFECT_NORMAL_HIT,         50, ROCK,         PHYSICAL,		100, 20,   0
	...
	move HYPNOSIS,     EFFECT_SLEEP,               0, PSYCHIC_TYPE, STATUS,			 80, 20,   0
	...
	move HARDEN,       EFFECT_DEFENSE_UP,          0, NORMAL,       STATUS,			100, 10,   0
	...
	move DEFENSE_CURL, EFFECT_DEFENSE_CURL,        0, NORMAL,       STATUS,			100, 15,   0
	...
	move LOVELY_KISS,  EFFECT_SLEEP,               0, NORMAL,       STATUS,			 80, 10,   0
	move SKY_ATTACK,   EFFECT_SKY_ATTACK,        140, FLYING,       SPECIAL,		 90,  5,  30
	move TRANSFORM,    EFFECT_TRANSFORM,           0, NORMAL,       STATUS,			100, 10,   0
	move AQUA_JET,     EFFECT_PRIORITY_HIT,       40, WATER,        PHYSICAL,		100, 30,  10
	...
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         80, ROCK,         PHYSICAL,		 95, 10,  30
	...
	move SLUDGE_BOMB,  EFFECT_POISON_HIT,         95, POISON,       SPECIAL,		100, 10,  30
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  20, GROUND,       SPECIAL,		100, 15, 100
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  65, WATER,        SPECIAL,		 85, 10,  50
	move SPIKES,       EFFECT_SPIKES,              0, GROUND,       STATUS,			100, 20,   0
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      160, ELECTRIC,     SPECIAL,		 50,  5, 100
	...
	move OUTRAGE,      EFFECT_RAMPAGE,            90, DRAGON,       SPECIAL,		100, 15,   0
	...
	move STEEL_WING,   EFFECT_DEFENSE_UP_HIT,     80, STEEL,        PHYSICAL,		 90, 25,  10
	...
	move FRUSTRATION,  EFFECT_FRUSTRATION,         1, NORMAL,       PHYSICAL,		100, 15,   0
	...
	move DYNAMICPUNCH, EFFECT_CONFUSE_HIT,       150, FIGHTING,     PHYSICAL,		 50,  5, 100
	...
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,  110, STEEL,        PHYSICAL,		 85, 15,  20
	...
	move CROSS_CHOP,   EFFECT_NORMAL_HIT,        105, FIGHTING,     PHYSICAL,		 80,  5,   0
	...
	move EXTREMESPEED, EFFECT_PRIORITY_HIT_2,     80, NORMAL,       PHYSICAL,		100,  5,   0
	...
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   70, FIGHTING,     PHYSICAL,		100, 15,  50
