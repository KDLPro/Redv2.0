...
; ANIM_OBJ_ACID
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_1D, BATTLEANIMFUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_VIOLET, ANIM_GFX_POISON
; ANIM_OBJ_SLUDGE
	battleanimobj RELATIVE_X, $b4, BATTLEANIMFRAMESET_1F, BATTLEANIMFUNC_SLUDGE, PAL_BATTLE_OB_VIOLET, ANIM_GFX_POISON
; ANIM_OBJ_SHADOW_BALL_POOF
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_08, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_VIOLET, ANIM_GFX_SMOKE
; ANIM_OBJ_BALL_POOF
...
; ANIM_OBJ_SKULL
	battleanimobj RELATIVE_X, $50, BATTLEANIMFRAMESET_1C, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_VIOLET, ANIM_GFX_POISON
; ANIM_OBJ_DIG_SAND
...
; ANIM_OBJ_POISON_GAS
	battleanimobj RELATIVE_X | X_FLIP, $78, BATTLEANIMFRAMESET_70, BATTLEANIMFUNC_POISON_GAS, PAL_BATTLE_OB_GRAY, ANIM_GFX_HAZE
; ANIM_OBJ_HORN
...
; ANIM_OBJ_SLUDGE_BOMB
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_VIOLET, ANIM_GFX_EGG
; ANIM_OBJ_PAY_DAY
...
; ANIM_OBJ_SHADOW_BALL
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $98, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_WAVE_TO_TARGET, PAL_BATTLE_OB_VIOLET, ANIM_GFX_EGG
; ANIM_OBJ_ROCK_SMASH
