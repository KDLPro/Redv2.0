...
; ANIM_OBJ_POISON_STING
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_02, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_POISON, ANIM_GFX_HIT
; ANIM_OBJ_PUNCH
...
; ANIM_OBJ_DRAGON_RAGE
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_0E, BATTLEANIMFUNC_WAVE_TO_TARGET, PAL_BATTLE_OB_RED_VIOLET, ANIM_GFX_FIRE
...
; ANIM_OBJ_ACID
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_1D, BATTLEANIMFUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_POISON, ANIM_GFX_POISON
; ANIM_OBJ_SLUDGE
	battleanimobj RELATIVE_X, $b4, BATTLEANIMFRAMESET_1F, BATTLEANIMFUNC_SLUDGE, PAL_BATTLE_OB_POISON, ANIM_GFX_POISON
; ANIM_OBJ_SLUDGE_2
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_BA, BATTLEANIMFUNC_SLUDGE, PAL_BATTLE_OB_POISON, ANIM_GFX_POISON
; ANIM_OBJ_SHADOW_BALL_POOF
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_08, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GHOST, ANIM_GFX_SMOKE
; ANIM_OBJ_BALL_POOF
...
; ANIM_OBJ_ROCK_TOMB
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_DROPNOBOUNCE, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS
; ANIM_OBJ_STRENGTH
...
; ANIM_OBJ_SING_1
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_24, BATTLEANIMFUNC_SING, PAL_BATTLE_OB_OTHERS_1, ANIM_GFX_NOISE
; ANIM_OBJ_SING_2
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_24, BATTLEANIMFUNC_SING, PAL_BATTLE_OB_OTHERS_3, ANIM_GFX_NOISE
; ANIM_OBJ_SING_3
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_24, BATTLEANIMFUNC_SING, PAL_BATTLE_OB_OTHERS_2, ANIM_GFX_NOISE
; ANIM_OBJ_WATER_GUN
...
; ANIM_OBJ_POWDER_S
	battleanimobj RELATIVE_X, $40, BATTLEANIMFRAMESET_2B, BATTLEANIMFUNC_POWDER, PAL_BATTLE_OB_YELLOW, ANIM_GFX_POWDER
; ANIM_OBJ_POWDER_V
	battleanimobj RELATIVE_X, $40, BATTLEANIMFRAMESET_2B, BATTLEANIMFUNC_POWDER, PAL_BATTLE_OB_POISON, ANIM_GFX_POWDER
; ANIM_OBJ_BEAM
...
; ANIM_OBJ_FURY_CUTTER_LEFT
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_41, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_YELLOW_GREEN, ANIM_GFX_CUT
; ANIM_OBJ_FURY_CUTTER_RIGHT
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_42, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_YELLOW_GREEN, ANIM_GFX_CUT
; ANIM_OBJ_WARP
...
; ANIM_OBJ_SOUND
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_59, BATTLEANIMFUNC_SOUND, PAL_BATTLE_OB_RED, ANIM_GFX_NOISE
; ANIM_OBJ_WAVE
...
; ANIM_OBJ_SCREEN_WALL
	battleanimobj RELATIVE_X | X_FLIP, $88, BATTLEANIMFRAMESET_BB, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_YELLOW, ANIM_GFX_REFLECT
; ANIM_OBJ_HARDEN
...
; ANIM_OBJ_SKULL
	battleanimobj RELATIVE_X, $50, BATTLEANIMFRAMESET_1C, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_POISON, ANIM_GFX_POISON
; ANIM_OBJ_DIG_SAND
...
; ANIM_OBJ_SMOG
	battleanimobj RELATIVE_X | X_FLIP, $48, BATTLEANIMFRAMESET_6F, BATTLEANIMFUNC_SPIRAL_DESCENT, PAL_BATTLE_OB_POISON, ANIM_GFX_HAZE
; ANIM_OBJ_POISON_GAS
	battleanimobj RELATIVE_X | X_FLIP, $78, BATTLEANIMFRAMESET_70, BATTLEANIMFUNC_POISON_GAS, PAL_BATTLE_OB_POISON, ANIM_GFX_HAZE
; ANIM_OBJ_HORN
...
; ANIM_OBJ_NEEDLE_2
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $90, BATTLEANIMFRAMESET_72, BATTLEANIMFUNC_NEEDLE, PAL_BATTLE_OB_GRAY_2, ANIM_GFX_HORN
...
; ANIM_OBJ_SLUDGE_BOMB
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_POISON, ANIM_GFX_EGG
; ANIM_OBJ_PAY_DAY
...
; ANIM_OBJ_SONICBOOM_JP_UNUSED
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_4A, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_SKY_BLUE, ANIM_GFX_WHIP
; ANIM_OBJ_MIMIC
...
; ANIM_OBJ_SWIFT
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_78, BATTLEANIMFUNC_USER_TO_TARGET_NO_STOP, PAL_BATTLE_OB_YELLOW, ANIM_GFX_OBJECTS
; ANIM_OBJ_KINESIS
...
; ANIM_OBJ_LICK
	battleanimobj RELATIVE_X | X_FLIP, $98, BATTLEANIMFRAMESET_7C, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GHOST, ANIM_GFX_WATER
; ANIM_OBJ_WITHDRAW
	battleanimobj RELATIVE_X | X_FLIP, $80, BATTLEANIMFRAMESET_7D, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_BLUE, ANIM_GFX_REFLECT
; ANIM_OBJ_DRAIN
...
; ANIM_OBJ_DEFENSE_CURL
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_86, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_SKY_BLUE, ANIM_GFX_SHAPES
...
; ANIM_OBJ_ANGER
	battleanimobj RELATIVE_X | X_FLIP, $80, BATTLEANIMFRAMESET_8C, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_RED, ANIM_GFX_MISC
; ANIM_OBJ_HEAL_BELL
...
; ANIM_OBJ_LOCK_ON
	battleanimobj RELATIVE_X | X_FLIP, $88, BATTLEANIMFRAMESET_8F, BATTLEANIMFUNC_LOCK_ON_MIND_READER, PAL_BATTLE_OB_RED, ANIM_GFX_MISC
...
; ANIM_OBJ_SPIKES
	battleanimobj RELATIVE_X | X_FLIP, $70, BATTLEANIMFRAMESET_8B, BATTLEANIMFUNC_SPIKES, PAL_BATTLE_OB_GRAY_2, ANIM_GFX_MISC
...
; ANIM_OBJ_DRAGONBREATH
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_11, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_RED_VIOLET, ANIM_GFX_FIRE
; ANIM_OBJ_DRAGONBREATH_FIRE
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_0F, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_RED_VIOLET, ANIM_GFX_FIRE
; ANIM_OBJ_CONVERSION
...
; ANIM_OBJ_LEER_SHINE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_B9, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_YELLOW, ANIM_GFX_SPEED
; ANIM_OBJ_NIGHTMARE
	battleanimobj RELATIVE_X | X_FLIP, $80, BATTLEANIMFRAMESET_9C, BATTLEANIMFUNC_DIZZY, PAL_BATTLE_OB_GHOST, ANIM_GFX_ANGELS
; ANIM_OBJ_IN_NIGHTMARE
	battleanimobj RELATIVE_X | X_FLIP, $80, BATTLEANIMFRAMESET_9D, BATTLEANIMFUNC_FLOAT_UP, PAL_BATTLE_OB_GHOST, ANIM_GFX_ANGELS
...
; ANIM_OBJ_CROSS_CHOP1
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_41, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_RED, ANIM_GFX_CUT
; ANIM_OBJ_CROSS_CHOP_2
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_42, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_RED, ANIM_GFX_CUT
; ANIM_OBJ_SANDSTORM
...
; ANIM_OBJ_ROLLOUT
	battleanimobj RELATIVE_X, $a8, BATTLEANIMFRAMESET_1A, BATTLEANIMFUNC_ROLLOUT, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS
; ANIM_OBJ_PSYCH_UP
...
; ANIM_OBJ_SHADOW_BALL
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $98, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_WAVE_TO_TARGET, PAL_BATTLE_OB_POISON, ANIM_GFX_EGG
; ANIM_OBJ_ROCK_SMASH
...
; ANIM_OBJ_WATERFALL
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_01, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_BLUE, ANIM_GFX_HIT
; ANIM_OBJ_WATERFALL_YFIX
...
; ANIM_OBJ_WATER_PULSE
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_5C, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BLUE, ANIM_GFX_PSYCHIC
; ANIM_OBJ_VOICE_HIT
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_5C, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_RED, ANIM_GFX_PSYCHIC
; ANIM_OBJ_PSYCHIC
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_5C, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_PINK, ANIM_GFX_PSYCHIC
