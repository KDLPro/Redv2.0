roms := redv2.gbc redv2-11.gbc redv2_au.gbc redv2_debug.gbc redv2-11_debug.gbc
...
redv2_obj         := $(rom_obj:.o=.o)
redv2-11_obj       := $(rom_obj:.o=11.o)
redv2_au_obj      := $(rom_obj:.o=_au.o)
redv2_debug_obj   := $(rom_obj:.o=_debug.o)
redv2-11_debug_obj := $(rom_obj:.o=11_debug.o)
...
.SUFFIXES:
.PHONY: all redv2 redv2-1 redv2_au redv2_debug redv2-1_debug clean tidy compare tools
.SECONDEXPANSION:
.PRECIOUS:
.SECONDARY:
...
all: redv2
redv2:         redv2.gbc
redv2-1:       redv2-11.gbc
redv2_au:      redv2_au.gbc
redv2_debug:   redv2_debug.gbc
redv2-1_debug:  redv2-11_debug.gbc
...
tidy:
	rm -f $(roms) $(redv2_obj) $(redv2-11_obj) $(redv2_au_obj) $(redv2_debug_obj) $(redv2-11_debug_obj) $(roms:.gbc=.map) $(roms:.gbc=.sym) rgbdscheck.o
	$(MAKE) clean -C tools/
...
$(redv2_obj):         RGBASMFLAGS +=
$(redv2-11_obj):       RGBASMFLAGS += -D _CRYSTAL11
$(redv2_au_obj):      RGBASMFLAGS += -D _CRYSTAL11 -D _CRYSTAL_AU
$(redv2_debug_obj):   RGBASMFLAGS += -D _DEBUG
$(redv2-11_debug_obj): RGBASMFLAGS += -D _CRYSTAL11 -D _DEBUG
...
$(foreach obj, $(redv2_obj), $(eval $(call DEP,$(obj),$(obj:.o=.asm))))
$(foreach obj, $(redv2-11_obj), $(eval $(call DEP,$(obj),$(obj:11.o=.asm))))
$(foreach obj, $(redv2_au_obj), $(eval $(call DEP,$(obj),$(obj:_au.o=.asm))))
$(foreach obj, $(redv2_debug_obj), $(eval $(call DEP,$(obj),$(obj:_debug.o=.asm))))
$(foreach obj, $(redv2-11_debug_obj), $(eval $(call DEP,$(obj),$(obj:11_debug.o=.asm))))

endif


redv2_opt         = -Cjv -t PM_CRYSTAL -i BYTE -n 0 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
redv2-11_opt       = -Cjv -t PM_CRYSTAL -i BYTE -n 1 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
redv2_au_opt      = -Cjv -t PM_CRYSTAL -i BYTU -n 0 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
redv2_debug_opt   = -Cjv -t PM_CRYSTAL -i BYTE -n 0 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
redv2-11_debug_opt = -Cjv -t PM_CRYSTAL -i BYTE -n 1 -k 01 -l 0x33 -m 0x10 -r 3 -p 0

redv2_base         = us
redv2-11_base       = us
redv2_au_base      = us
redv2_debug_base   = dbg
redv2-11_debug_base = dbg
...
gfx/poke_balls/great_ball.2bpp: tools/gfx += --remove-xflip --keep-whitespace
gfx/poke_balls/ultra_ball.2bpp: tools/gfx += --remove-xflip --keep-whitespace
gfx/poke_balls/master_ball.2bpp: tools/gfx += --remove-xflip --keep-whitespace
gfx/poke_balls/level_ball.2bpp: tools/gfx += --remove-xflip --keep-whitespace
gfx/poke_balls/lure_ball.2bpp: tools/gfx += --remove-xflip --keep-whitespace
gfx/poke_balls/moon_ball.2bpp: tools/gfx += --remove-xflip --keep-whitespace
gfx/poke_balls/friend_ball.2bpp: tools/gfx += --remove-xflip --keep-whitespace
gfx/poke_balls/fast_ball.2bpp: tools/gfx += --remove-xflip --keep-whitespace
gfx/poke_balls/heavy_ball.2bpp: tools/gfx += --remove-xflip --keep-whitespace
gfx/poke_balls/love_ball.2bpp: tools/gfx += --remove-xflip --keep-whitespace
gfx/poke_balls/park_ball.2bpp: tools/gfx += --remove-xflip --keep-whitespace
