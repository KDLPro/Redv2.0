...
TilesetKantoAnim:
TilesetSSAnneCaptainAnim:
TilesetSSAnneDeckAnim:
TilesetKantoDojoAnim:
TilestCyclingRoadAnim:
TilesetKantoPoliceAnim:
TilesetKantoSandyAnim:
TilesetKantoPowerAnim:
...
TilesetSSAnneAnim:
TilesetSSAnneRooms1Anim:
TilesetSSAnneRooms2Anim:
