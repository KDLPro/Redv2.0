...
endr
	...
	tilepal 1, GRAY, GRAY, GRAY, GRAY, WATER, ROOF, BROWN, BROWN
	tilepal 1, GRAY, GRAY, GRAY, GRAY, WATER, WATER, GRAY, GRAY
	tilepal 1, GRAY, GRAY, BROWN, BROWN, GRAY, GRAY, BROWN, BROWN
	tilepal 1, GRAY, GREEN, GRAY, GRAY, BROWN, BROWN, BROWN, GRAY
	tilepal 1, GRAY, GRAY, GREEN, GRAY, GRAY, GRAY, BROWN, BROWN
	tilepal 1, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, GREEN, GRAY
	tilepal 1, GREEN, GREEN, GRAY, GRAY, GRAY, GRAY, BROWN, BROWN
	tilepal 1, BROWN, BROWN, BROWN, BROWN, GRAY, GRAY, GRAY, RED
