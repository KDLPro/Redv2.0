...
AnimObjPokeBallBGGFX:   INCBIN "gfx/poke_balls/ball_background.2bpp.lz"


SECTION "Battle Ball Icons", ROMX

AnimObjPokeBallGFX::    INCBIN "gfx/poke_balls/poke_ball.2bpp.lz"
AnimObjGreatBallGFX::   INCBIN "gfx/poke_balls/great_ball.2bpp.lz"
AnimObjUltraBallGFX::   INCBIN "gfx/poke_balls/ultra_ball.2bpp.lz"
AnimObjMasterBallGFX::  INCBIN "gfx/poke_balls/master_ball.2bpp.lz"
AnimObjLevelBallGFX::   INCBIN "gfx/poke_balls/level_ball.2bpp.lz"
AnimObjLureBallGFX::    INCBIN "gfx/poke_balls/lure_ball.2bpp.lz"
AnimObjMoonBallGFX::    INCBIN "gfx/poke_balls/moon_ball.2bpp.lz"
AnimObjFriendBallGFX::  INCBIN "gfx/poke_balls/friend_ball.2bpp.lz"
AnimObjFastBallGFX::    INCBIN "gfx/poke_balls/fast_ball.2bpp.lz"
AnimObjHeavyBallGFX::   INCBIN "gfx/poke_balls/heavy_ball.2bpp.lz"
AnimObjLoveBallGFX::    INCBIN "gfx/poke_balls/love_ball.2bpp.lz"
AnimObjParkBallGFX::    INCBIN "gfx/poke_balls/park_ball.2bpp.lz"