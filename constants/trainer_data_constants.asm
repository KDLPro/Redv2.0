...
SWITCH_COMPETITIVE  EQU 1 << SWITCH_COMPETITIVE_F
...
TRAINERTYPE_ITEM_MOVES_NICK 				EQU TRAINERTYPE_MOVES | TRAINERTYPE_ITEM | TRAINERTYPE_NICKNAME
TRAINERTYPE_DVS        						EQU 1 << TRAINERTYPE_DVS_F
TRAINERTYPE_EVS   							EQU 1 << TRAINERTYPE_EVS_F
TRAINERTYPE_COMPETITIVE_BASIC_NO_NICK		EQU TRAINERTYPE_MOVES | TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_EVS
TRAINERTYPE_COMPETITIVE_BASIC				EQU TRAINERTYPE_COMPETITIVE_BASIC_NO_NICK | TRAINERTYPE_NICKNAME
TRAINERTYPE_VARIABLE   						EQU 1 << TRAINERTYPE_VARIABLE_F
TRAINERTYPE_HAPPINESS  						EQU 1 << TRAINERTYPE_HAPPINESS_F
TRAINERTYPE_COMPETITIVE_ADVANCED_NO_NICK	EQU TRAINERTYPE_COMPETITIVE_BASIC_NO_NICK | TRAINERTYPE_VARIABLE_F | TRAINERTYPE_HAPPINESS_F
TRAINERTYPE_COMPETITIVE_ADVANCED			EQU TRAINERTYPE_COMPETITIVE_ADVANCED_NO_NICK | TRAINERTYPE_NICKNAME

PERFECT_DV EQU $11 ; treated as $FF in enemy party data
PERFECT_STAT_EXP EQU $1 ; treated as $FFFF in enemy party data
