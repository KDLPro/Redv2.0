; GetSGBLayout arguments (see engine/gfx/cgb_layouts.asm and engine/gfx/sgb_layouts.asm)
	...
	const SCGB_MON_NAMING_SCREEN
	const SCGB_BOX_NAMING_SCREEN
	const SCGB_MAIL_NAMING_SCREEN
	const SCGB_HUMAN_NAMING_SCREEN
	const SCGB_BACK_TO_PC
	const SCGB_DONENAMING
	const SCGB_DONENAMING_JUSTCAUGHT
...
; GetPredefPal arguments (see engine/gfx/color.asm)
	...
	const PREDEFPAL_TOP_BACKGROUND_1
	const PREDEFPAL_BOTTOM_BACKGROUND_1
	const PREDEFPAL_BORDER_1
	const PREDEFPAL_TOP_BACKGROUND_2
	const PREDEFPAL_BOTTOM_BACKGROUND_2
	const PREDEFPAL_BORDER_2
	const PREDEFPAL_TOP_BACKGROUND_3
	const PREDEFPAL_BOTTOM_BACKGROUND_3
	const PREDEFPAL_BORDER_3
	const PREDEFPAL_TOP_BACKGROUND_4
	const PREDEFPAL_BOTTOM_BACKGROUND_4
	const PREDEFPAL_BORDER_4
	const PREDEFPAL_TEXT
